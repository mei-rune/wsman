...
const EnumerateTemplate = `<?xml version="1.0" encoding="UTF-8"?>
<env:Envelope xmlns:env="` + NS_SOAP_ENV + `" xmlns:a="` + NS_ADDRESSING + `" xmlns:p="` + NS_WSMAN_MSFT + `" xmlns:w="` + NS_WSMAN_DMTF + `" xmlns:n="` + NS_ENUM + `">
  <env:Header>
...
const PullTemplate = `<?xml version="1.0" encoding="UTF-8"?>
<env:Envelope xmlns:env="` + NS_SOAP_ENV + `" xmlns:a="` + NS_ADDRESSING + `" xmlns:p="` + NS_WSMAN_MSFT + `" xmlns:w="` + NS_WSMAN_DMTF + `" xmlns:n="` + NS_ENUM + `">
  <env:Header>
